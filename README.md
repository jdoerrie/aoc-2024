...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `86.7µs` | `76.4µs` |
| [Day 2](./src/bin/02.rs) | `95.4µs` | `122.8µs` |
| [Day 3](./src/bin/03.rs) | `195.2µs` | `281.2µs` |
| [Day 4](./src/bin/04.rs) | `957.5µs` | `960.5µs` |
| [Day 5](./src/bin/05.rs) | `143.3µs` | `139.3µs` |
| [Day 6](./src/bin/06.rs) | `519.3µs` | `275.7ms` |
| [Day 7](./src/bin/07.rs) | `197.2µs` | `3.5ms` |
